                    ...
                    <div>
                        ...
                        <ul className="mt-12 space-y-8">
                            <li className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fillRule='#fff'
                                ...
                                <a href="#" className="text-white text-sm ml-3">
                                    <strong>shimmersecurities@gmail.com</strong>
                                    <br />
                                    <strong>info@shimmersecurity.in</strong>
                                </a>
                            </li>
                            <li className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fillRule='#fff' viewBox="0 0 482.6 482.6">
                            ...
                            <li className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fillRule='#fff' viewBox="0 0 368.16 368.16">
                                ...
                                <a href="javascript:void(0)" className="text-white text-sm ml-3">
                                    <strong>Lohiya Nagar, opp Central Bank of India
                                        Kankarbagh,Patna-20
                                    </strong>
                                </a>
                            </li>
                        ...
                        <ul className="flex mt-12 space-x-4">
                            <li className="bg-[#a91079] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0 ">
                                <a  href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fillRule='#fff'
                                        viewBox="0 0 24 24" >
                                        <path
                    ...
                    <div className="bg-gray-200 p-6 rounded-lg">
                        ...
                        <form className="mt-8 space-y-4">
                            ...
                            <button type='button'
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fillRule='#fff' className="mr-2" viewBox="0 0 548.244 548.244">
                                    <path fillrule-rule="evenodd" d="M392.19 156.054 211.268 281.667 22.032 218.58C8.823 214.168-.076 201.775 0 187.852c.077-13.923 9.078-26.24 22.338-30.498L506.15 1.549c11.5-3.697 24.123-.663 32.666 7.88 8.542 8.543 11.577 21.165 7.879 32.666L390.89 525.906c-4.258 13.26-16.575 22.261-30.498 22.338-13.923.076-26.316-8.823-30.728-22.032l-63.393-190.153z" clipRule="evenodd" data-original="#000000" />
                                </svg>
                                Send Message
                            </button>
                        </form>
